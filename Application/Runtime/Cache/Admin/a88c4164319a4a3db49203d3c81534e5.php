	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file">
                    <img width="100" src="<?php echo ($vol["thumb"]); ?>" alt=""/>
                    <?php if(!empty($vol["thumb"])): ?>【<a href="/index.php/Admin/Knowledge/download/id/<?php echo ($vol["id"]); ?>">下载</a>】<?php endif; ?>
                </td>
                <td class="description"><?php echo ($vol["description"]); ?></td>
