	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="status"><?php if($val["isread"] == 1): ?>已读<?php else: ?>未读<?php endif; ?></td>
                    <td class="operate">
                        <a href ='javascript:;' class="show" data-title="<?php echo ($val["title"]); ?>" data="<?php echo ($val["id"]); ?>" isread="<?php echo ($val["isread"]); ?>">查看</a>
                        <a href ='javascript:;' class="del">删除</a>
                    </td>
