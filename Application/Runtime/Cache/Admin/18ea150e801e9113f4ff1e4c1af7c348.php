		...
		<div class="short-input select ue-clear">
			...
			<div class="select-wrap">
				<select name="pid">
					...
					<?php if(is_array($ids)): $i = 0; $__LIST__ = $ids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if($vol["id"] == $data["pid"] ): ?>selected="selected"<?php endif; ?>><?php echo ($vol["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
		<p class="short-input ue-clear">
